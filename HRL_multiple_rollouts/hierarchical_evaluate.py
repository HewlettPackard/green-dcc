...
assert os.path.exists(hl_checkpoint_path), f"Error: High Level weights path does not exist: {hl_checkpoint_path}"
...
ax1.plot(df['DC1 Queue Tasks'][:], label='DC1 Queue Tasks', linewidth=2)
ax1.plot(df['DC2 Queue Tasks'][:], label='DC2 Queue Tasks', linewidth=2)
ax1.plot(df['DC3 Queue Tasks'][:], label='DC3 Queue Tasks', linewidth=2)
