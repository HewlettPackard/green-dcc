...
dc_checkpoint_path = chkpt_directory + "DC_PPO_{}_{}_{}.pth".format(env_name, random_seed, run_num_pretrained)
...
ax1.plot(pd['DC1 Original Workload'][:100], label='DC1 Original Workload', linewidth=2)
ax1.plot(pd['DC1 Spatial Shifted Workload'][:100], linestyle='--', label='DC1 Spatial Shifted Workload', linewidth=2)
ax1.plot(pd['DC1 Temporal Shifted Workload'][:100], linestyle='-.', label='DC1 Temporal Shifted Workload', linewidth=2)
ax1.set_title('Original Workload vs Spatial Shifted Workload vs Temporal Shifted Workload')

# ax1.plot(pd['DC2 Original Workload'][:100], label='DC2 Original Workload', linewidth=2)
# ax1.plot(pd['DC2 Spatial Shifted Workload'][:100], linestyle='--',label='DC2 Spatial Shifted Workload', linewidth=2)
# ax1.plot(pd['DC2 Temporal Shifted Workload'][:100], linestyle='-.',label='DC2 Temporal Shifted Workload', linewidth=2)

# ax1.plot(pd['DC3 Original Workload'][:100], label='DC3 Original Workload', linewidth=2)
# ax1.plot(pd['DC3 Spatial Shifted Workload'][:100], linestyle='--',label='DC3 Spatial Shifted Workload', linewidth=2)
# ax1.plot(pd['DC3 Temporal Shifted Workload'][:100], linestyle='-.',label='DC3 Temporal Shifted Workload', linewidth=2)
...
fig, ax1 = plt.subplots(figsize=(12, 5))  # Adjust height as necessary
ax1.plot(pd['HL Action 1'][:100], label='HL Action 1', linewidth=2)
...
ax2 = ax1.twinx()
ax2.plot(pd['DC1 Carbon Intensity'][:100], label='DC1 Carbon Intensity', linewidth=2, color='red')
