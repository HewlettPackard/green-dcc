...
import HRL_multiple_rollouts_sequential.ppo as ppo_class
...
class HierarchicalPPO:
    ...
    def __init__(self, num_ll_policies, 
        ...
        self.high_policy = ppo_class.PPO(obs_dim_hl, action_dim_hl,
                                        hl_lr_actor, hl_lr_critic, hl_gamma, hl_K_epochs, eps_clip, hl_has_continuous_action_space, action_std_init, init_output_bias=0.0)
        ...
        self.low_policies = {policy_id: ppo_class.PPO(state_dim + goal_dim, action_dim, ll_lr_actor, ll_lr_critic, ll_gamma, ll_K_epochs, eps_clip, ll_has_continuous_action_space, action_std_init, init_output_bias=1.0)
    ...
    #     return loss
    def update_with_experiences(self, aggregated_experiences, update_high_policy=True, update_low_policies=True):
