...
class CarbonLoadEnv(gym.Env):
    def __init__(
        ...
        # The max_utilization levels are from 50% to 70%
    ...
    def step(self, action, workload_rest_day=0):
        ...
        """
        # Assert the action with the action space
        ...
        # max_utilization = max_utilization_level / 3.0  # Converts levels 0-5 to 0.0-1.0

        # Convert max_utilization to a percentage for calculations
        max_utilization_percentage = int(50 + max_utilization_level * 10)
