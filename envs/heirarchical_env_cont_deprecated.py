...
class HeirarchicalDCRL(gym.Env):
    ...
    def safety_enforcement(self, actions: dict):
        ...
        current_datacenter_workload = copy.deepcopy(original_workload)  # This will be dynamically updated
        net_transfer = {dc: 0.0 for dc in self.datacenters}

        # Initialize total transferred workload
    ...
    def calc_reward(self) -> float:
        ...
        for dc in self.low_level_infos:
            ...
            standarized_carbon_footprint = self.standarize_carbon_footprint(carbon_footprint)
        ...
        transfer_cost_coeff = 0.1  # Adjust this coefficient based on experimentation
