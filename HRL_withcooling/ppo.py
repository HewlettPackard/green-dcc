...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs,
                 eps_clip, has_continuous_action_space, action_std_init=0.6, batch_size=128):
    ...
    def update(self):
        ...
        for _ in range(self.K_epochs):
            ...
            for start in range(0, len(rewards), self.batch_size):
                ...
                # Create mini-batches
                batch_states = old_states[minibatch_indices]
                batch_actions = old_actions[minibatch_indices]
                batch_logprobs = old_logprobs[minibatch_indices]
                batch_advantages = advantages[minibatch_indices]
                batch_rewards = rewards[minibatch_indices]
